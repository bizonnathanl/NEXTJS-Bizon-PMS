    ...
    <header className="mb-12">
      <div className="flex items-center justify-between mb-12 gap-2">
        <div className="flex gap-sm items-center w-1/2">
          <img
            src="/icons/SVG_Sidebar-left.svg"
            alt="Close sidebar"
            className="w-7 aspect-square text-dark"
          />
          <hr className="w-7 bg-[#09002F] rotate-90 h-[2px]" />
          <Breadcrumb
            aria-label="breadcrumb"
            className="breadcrumbs-links w-full">
            <BreadcrumbList>
        ...
        <form
          className="flex items-center gap-1 w-1/2 max-w-[400px]"
          ...
          <Button
            variant="outline"
            type="submit"
            className="w-[40px] p-0 aspect-square border-0 bg-transparent cursor-pointer">
            <img
